...
const Menu = ({ show, shuffle, onClose, className, onNavigate, shuffleComponent }) => {
  return (
    <div className={join('menu-container-mobile', show, shuffle?.title, className)}>
      <button
  ...
  return (
    <>
      <div
        ...
        className={join('flex-center-xy', 'navigation-mobile', className, shuffle?.title)}>
        ...
        <div>
          <button className={join('menu-button', className)} onClick={() => setOpenSideBar(true)}>
            <Icon>menu</Icon>
          </button>
        </div>
        <Menu
      ...
      <div className="navigation-container" role="navigation" aria-label="Navigation Desktop">
        <a className={join('p', 'skip-content')} href="#main">
          Skip To Page Content
        </a>
        <div
        ...
        <nav className={join('navigation-normal', 'flex')}>
          <div className={join('navigation-items', 'flex-center-xy', className)}>
...
Navigation.propTypes = {
  shuffleComponent: PropTypes.element
};
