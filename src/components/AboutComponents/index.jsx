        ...
        <div className="about-me-col-2">
          ...
          <div ref={cbRef} className="ref-container-styles" />
            ...
            <p className="p">
              ...
              experiences. I have experience in Graphic Design, which allows me to
              bring a unique perspective to my development projects, combining
              my technical skills with a keen eye for aesthetics and usability.
            </p>
            <Button
