          ...
          <div id="main" role="main" className="width-100">
            ...
            <div className="about-content-container">
              ...
              <div className="about-content-description">
                <p className="p">
                  {" "}
                  I'm Jose M. Aguilar a Software developer with 6 years of
                  experience. I'm passionate about creating innovative and
                  user-friendly web applications that deliver exceptional user
                  experiences. I have experience in Graphic Design, which allows
                  me to bring a unique perspective to my development projects,
                  combining my technical skills with a keen eye for aesthetics
                  and usability.
                </p>
                <p className="p">
                  Over the past decade, I've honed my skills in a range of
                  areas, including frontend development using technologies like
                  React and animations, as well as backend development using
                  Golang. I'm also well-versed in the latest software
                  development methodologies, including Agile and DevOps, and I'm
                  always looking for ways to improve my workflow and stay ahead
                  of the curve.
                </p>
              </div>
            </div>
            ...
            <div className="about-content-container start">
              <div className="about-content-image">
                <p className="p">
                  It has been a privilege for me to partner with a wide range of
                  clients, both big and small, from all corners of the globe.
                  Throughout my career, I have been fortunate enough to work on
                  several notable projects, and I am grateful for the
            ...
            <div>
              <p style={{ color: 'black' }} className="p">Want to check some projects?</p>
              <NextProduct
                nextProduct={{
                  id: "product-2",
